...
from qstrader.broker.portfolio_mc.position_cash_mc import PositionCash_MC

##TC - Need to add logic that creates new position if direction changes

class PositionCashHandler_MC(object):
    """
    ...
    def transact_cash_position(self, transaction):
        ...
        if asset in self.positions:
            ...
            position = PositionCash_MC.open_from_transaction(transaction)
