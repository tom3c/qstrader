...
DEFAULT_PORTFOLIO_CURS = ['USD', 'EUR']
DEFAULT_PORTFOLIO_NAME = 'Backtest Simulated Broker Portfolio'


class BacktestTradingSessionMultiCurrency(TradingSession):
    """
    ...
    def __init__(
        ...
        portfolio_ids=DEFAULT_PORTFOLIO_CURS,
    ...
    def _create_broker(self):
        ...
        portfolios = ['port_%s' % currency for currency in self.portfolio_ids]
        for portfolio in portfolios:
            broker.create_portfolio(portfolio, portfolio)
            broker.subscribe_funds_to_portfolio(portfolio, self.initial_cash/2)
