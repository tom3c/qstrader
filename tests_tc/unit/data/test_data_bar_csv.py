...
def test_bar_data_csv():
    ...
    data_source_equity = CSVDailyBarDataSource(csv_dir, Equity_MC, csv_symbols=['SPY','MSE'])
    ...
    mid_price_spy = data_handler.get_asset_latest_mid_price(dt, 'EQ:SPY')
    mid_price_mse = data_handler.get_asset_latest_mid_price(dt, 'EQ:MSE')
    mid_price_eur = data_handler.get_asset_latest_mid_price(dt, 'FX:EUR')
